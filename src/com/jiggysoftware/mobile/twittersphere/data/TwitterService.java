...
public final class TwitterService {
	...
	private String sourceApp = "twittersphere";
...
//	private Format format = Format.xml;
	 ...
	 */
	public TwitterService(String name, String password) {
		this.name = name;
	 ...
	 */
	public User notify(String username) throws TwitterException {
	 ...
	 * @return the specified user
	 */
	public User leaveNotifications(String username) throws TwitterException{
	 ...
	 */
	public int getRateLimitStatus() throws TwitterException {
